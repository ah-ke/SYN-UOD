...
DIR_CITYSCAPES="G:/Dataset/cityscapes"
DIR_CITYSCAPES_SMALL="G:/Anomaly/Detecting/detecting-the-unexpected-master/datasets/dataset_Cityscapes/1024x512"

python compress_images.py \
	$DIR_CITYSCAPES/leftImg8bit \
